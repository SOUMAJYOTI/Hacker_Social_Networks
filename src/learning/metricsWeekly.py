...
def select_attack_days(eventsDf, start_date, thresh):
    ...
    for idx, row in eventsDf.iterrows():
        if row['number_attacks'] >= thresh and row['start_dates'] > start_date.datf1:
...
def main():
    ...
    # pickle.dump(metricsDict, open('../../data/results/01_25/supervised/malicious_email/metricsWeekly_best.pickle', 'wb') )
