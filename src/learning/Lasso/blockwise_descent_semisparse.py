...
class SGL:
        ...
        for iter_outer in range(self.max_iter_outer):
            ...
            for gr in range(n_groups):
                ...
                if self.discard_group(X, y, indices_group_k):
                    ...
                    # this is the same as fabian's lasso code
            ...
            # TODO: can be modified to a different stopping criterion
    ...
    def discard_group(self, X, y, ind):
        ...
        # print(norm_2, (1 - self.alpha) * self.lbda * p_l)
    ...
    # this function just calculates the maximum of the lambda value taken from the paper
    @classmethod
...
class SGL_LogisticRegression(SGL):
    ...
    def predict(self, X):
        ...
        y[numpy.exp(numpy.dot(X, self.coef_)) < 0.8] = 0.
        return y
